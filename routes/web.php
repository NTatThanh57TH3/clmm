...
Route::post('/admin/login-action', [AdminController::class, 'LoginAction'])
    ->name('admin_login_action')
    ->middleware('guest');
...
Route::group(['prefix' => '/admin', 'middleware' => 'auth'], function() {
    ...
    Route::post('/quanlysdt/edit/action', [AdminController::class, 'EditSDTAction'])
        ->name('admin_quanlysdt_edit_action');
    ...
    Route::post('/setting/chan-le-action', [AdminController::class, 'SettingChanLeAction'])
        ->name('admin_setting_chanle_action');
    Route::get('/setting/tai-xiu', [AdminController::class, 'SettingTaiXiu'])->name('admin_setting_taixiu');
    Route::post('/setting/tai-xiu-action', [AdminController::class, 'SettingTaiXiuAction'])
        ->name('admin_setting_taixiu_action');
    Route::get('/setting/chan-le-2', [AdminController::class, 'SettingChanLe2'])->name('admin_setting_chanle2');
    Route::post('/setting/chan-le-2-action', [AdminController::class, 'SettingChanLeAction2'])
        ->name('admin_setting_chanle_action2');
    Route::get('/setting/gap-3', [AdminController::class, 'SettingGap3'])->name('admin_setting_gap3');
    Route::post('/setting/gap-3-action', [AdminController::class, 'SettingGap3Action'])
        ->name('admin_setting_gap3_action');
    Route::get('/setting/tong-3-so', [AdminController::class, 'SettingTong3So'])->name('admin_setting_tong3so');
    Route::post('/setting/tong-3-so-action', [AdminController::class, 'SettingTong3SoAction'])
        ->name('admin_setting_tong3so_action');
    Route::get('/setting/1-phan-3', [AdminController::class, 'Setting1Phan3'])->name('admin_setting_1phan3');
    Route::post('/setting/1-phan-3-action', [AdminController::class, 'Setting1Phan3Action'])
        ->name('admin_setting_1phan3_action');
    Route::get('/setting/no-hu', [AdminController::class, 'SettingNoHu'])->name('admin_setting_nohu');
    Route::post('/setting/no-hu-action', [AdminController::class, 'SettingNoHuAction'])
        ->name('admin_setting_nohu_action');
    ...
    Route::post('/setting/doi-mat-khau-action', [AdminController::class, 'DoiMatKhauAction'])
        ->name('admin_doi_mat_khau_action');
    ...
    Route::post('/setting/config-message-action', [AdminController::class, 'ConfigMessageAction'])
        ->name('admin_config_message_action');
